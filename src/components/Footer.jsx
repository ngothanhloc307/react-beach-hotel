  ...
  return (
    <div className="w-full mt-24 bg-gray-900 text-gray-300 px-2 py-2">
      <div className="max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-gray-600 py-8 px-4">
        ...
        <div>
          <h6 className="font-bold uppercare pt-2">Companyul</h6>
          <ul>
      ...
      <div className="flex flex-col max-w-[1400px] px-2 py-4 justify-between sm:flex-row text-gray-500">
        <p className="py-4 px-2">2022 Expriences, LL, ALl rights reserved</p>
        <div className="flex justify-between sm:w-[300px] pt-4 text-2xl">
          <FaFacebook className="cursor-pointer hover:text-white" />
          <FaTwitter className="cursor-pointer hover:text-white" />
          <FaInstagram className="cursor-pointer hover:text-white" />
          <TiSocialPinterest className="cursor-pointer hover:text-white" />
        </div>
      </div>
    </div>
  );
